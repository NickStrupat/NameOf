...
namespace AssemblyToProcess {
    public static class Invocations {
        ...
        public static void Static() {
            ...
            Assert.AreEqual(Name.OfEvent(() => StaticClass.StaticClassEvent += (o,e)=>{}), "StaticClassEvent");
        }
        public static void StaticInstance() {
            ...
            Assert.AreEqual(Name.OfEvent<InstanceClass>(x => x.InstanceClassEvent += (o, e) => { }), "InstanceClassEvent");
        }
